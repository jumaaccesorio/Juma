          ...
          {cartRows.length === 0 ? (
            ...
            <>
              ...
              <div className="flex justify-end pt-4">
                <button onClick={onClearCart} className="flex items-center gap-2 text-sm font-medium text-slate-500 hover:text-primary transition-colors">
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="flex justify-between text-slate-500">
                ...
                {cartTotal >= 50000 ? (
                  ...
                  <span className="font-medium text-slate-900 dark:text-slate-100 cursor-help" title="Envio gratis desde $50.000">A calcular</span>
                )}
              </div>
